	...
	<div>
    	...
    	<table>
			...
			<tr bgcolor="#000" >
				...
				<th align = "center">Employee Fname</th>
				<th align = "center">Employee Lname</th>
				<th align = "center">Emp Mail</th>
				<th align = "center">     </th>
			...
			<?php
			$sql5 = "SELECT * FROM `employee` WHERE id = $id";
			$result5 = mysqli_query($conn, $sql5);
			//$name = $result5['']
				// $seq = 1;
				$foundrow=mysqli_fetch_assoc($result5);
