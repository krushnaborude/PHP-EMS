...
$sql = "SELECT employee.id,employee.firstName,employee.lastName,designation,salary.base,salary.bonus,salary.total from employee,`salary` where employee.id=salary.id";
